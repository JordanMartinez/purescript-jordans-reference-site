    ...
    - [Basic Syntax](./content/11-Syntax/01-Basic-Syntax/Readme.md)
        - [src]()
            ...
            - [TypeClasses and Newtypes]()
                - [Single Paramter.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/01-Single-Paramter-ps.md)
                - [Constraining Types Using Typeclasses.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/02-Constraining-Types-Using-Typeclasses-ps.md)
                - [Dictionaries: How Type Classes Work.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/03-Dictionaries--How-Type-Classes-Work-ps.md)
                - [Special Type Classes]()
                    - [Partial.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/03-Special-Type-Classes/01-Partial-ps.md)
                    - [Coercible.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/03-Special-Type-Classes/02-Coercible-ps.md)
                - [Typeclass Relationships.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/04-Typeclass-Relationships-ps.md)
                - [Typeclasses with No Definitions.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/05-Typeclasses-with-No-Definitions-ps.md)
                - [Type Class Kind Signatures.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/06-Type-Class-Kind-Signatures-ps.md)
                - [Multi Paramter.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/07-Multi-Paramter-ps.md)
                - [Functional Dependencies.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/08-Functional-Dependencies-ps.md)
                - [Instance Chains.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/09-Instance-Chains-ps.md)
                - [Keyword: Newtype.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/11-Keyword--Newtype-ps.md)
                - [Recursive Types Newtypes.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/12-Recursive-Types-Newtypes-ps.md)
                - [Deriving Common Typeclass Instances for Custom Types.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/21-Deriving-Common-Typeclass-Instances-for-Custom-Types-ps.md)
                - [Deriving Typeclass Instances for Newtyped Types.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/22-Deriving-Typeclass-Instances-for-Newtyped-Types-ps.md)
                - [Type Equality Not Propagate.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/41-Type-Equality-Not-Propagate-ps.md)
                - [Designing Typeclasses](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses-and-Newtypes/91-Designing-Typeclasses.md)
