...
- [Build Tools](./content/03-Build-Tools/Readme.md)
    ...
    - [Continuous Integration](./content/03-Build-Tools/04-Continuous-Integration/Readme.md)
...
- [Syntax](./content/11-Syntax/Readme.md)
    - [Basic Syntax](./content/11-Syntax/01-Basic-Syntax/Readme.md)
        - [src]()
            ...
            - [Special Compiler Features]()
                ...
                - [Typed Holes On Complex Expressions.purs](./content/11-Syntax/01-Basic-Syntax/src/03-Special-Compiler-Features/41-Typed-Holes-On-Complex-Expressions-ps.md)
            - [Various Keywords]()
            ...
            - [TypeClasses]()
                ...
                - [Typeclass Relationships.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses/04-Typeclass-Relationships-ps.md)
                - [Typeclasses with No Definitions.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses/05-Typeclasses-with-No-Definitions-ps.md)
                - [Type Class Kind Signatures.purs](./content/11-Syntax/01-Basic-Syntax/src/11-TypeClasses/06-Type-Class-Kind-Signatures-ps.md)
            ...
            - [Newtypes]()
                - [Keyword: Newtype.purs](./content/11-Syntax/01-Basic-Syntax/src/12-Newtypes/01-Keyword--Newtype-ps.md)
                - [Recursive Types Newtypes.purs](./content/11-Syntax/01-Basic-Syntax/src/12-Newtypes/02-Recursive-Types-Newtypes-ps.md)
            - [Deriving Instances]()
                - [Supported Compiler TypeClasses.purs](./content/11-Syntax/01-Basic-Syntax/src/13-Deriving-Instances/01-Supported-Compiler-TypeClasses-ps.md)
                - [Instances for Newtyped Types.purs](./content/11-Syntax/01-Basic-Syntax/src/13-Deriving-Instances/02-Instances-for-Newtyped-Types-ps.md)
                - [Deriving Newtype.purs](./content/11-Syntax/01-Basic-Syntax/src/13-Deriving-Instances/11-Deriving-Newtype-ps.md)
                - [Deriving Generic.purs](./content/11-Syntax/01-Basic-Syntax/src/13-Deriving-Instances/12-Deriving-Generic-ps.md)
            - [Special Type Classes]()
                - [Partial.purs](./content/11-Syntax/01-Basic-Syntax/src/14-Special-Type-Classes/01-Partial-ps.md)
                - [Coercible.purs](./content/11-Syntax/01-Basic-Syntax/src/14-Special-Type-Classes/02-Coercible-ps.md)
            - [TypeClass Gotchas]()
                - [Type Equality Not Propagate.purs](./content/11-Syntax/01-Basic-Syntax/src/15-TypeClass-Gotchas/01-Type-Equality-Not-Propagate-ps.md)
                - [Global Instances](./content/11-Syntax/01-Basic-Syntax/src/15-TypeClass-Gotchas/02-Global-Instances.md)
                - [Designing TypeClasses](./content/11-Syntax/01-Basic-Syntax/src/15-TypeClass-Gotchas/11-Designing-TypeClasses.md)
            - [Visible Type Applications]()
                - [Intro.purs](./content/11-Syntax/01-Basic-Syntax/src/16-Visible-Type-Applications/01-Intro-ps.md)
                - [Order Matters.purs](./content/11-Syntax/01-Basic-Syntax/src/16-Visible-Type-Applications/02-Order-Matters-ps.md)
                - [Skipping Wildcards.purs](./content/11-Syntax/01-Basic-Syntax/src/16-Visible-Type-Applications/03-Skipping-Wildcards-ps.md)
                - [Usage.purs](./content/11-Syntax/01-Basic-Syntax/src/16-Visible-Type-Applications/04-Usage-ps.md)
                - [TypeClasses.purs](./content/11-Syntax/01-Basic-Syntax/src/16-Visible-Type-Applications/05-TypeClasses-ps.md)
                - [Gotchas.purs](./content/11-Syntax/01-Basic-Syntax/src/16-Visible-Type-Applications/11-Gotchas-ps.md)
    ...
    - [Foreign Function Interface](./content/11-Syntax/02-Foreign-Function-Interface/Readme.md)
        - [src]()
            - [Same File Name.js](./content/11-Syntax/02-Foreign-Function-Interface/src/01-Same-File-Name-js.md)
            - [Same File Name.purs](./content/11-Syntax/02-Foreign-Function-Interface/src/01-Same-File-Name-ps.md)
            - [Other Bindings.js](./content/11-Syntax/02-Foreign-Function-Interface/src/02-Other-Bindings-js.md)
            - [Bindings Tip.js](./content/11-Syntax/02-Foreign-Function-Interface/src/03-Bindings-Tip-js.md)
            - [Bindings Tip.purs](./content/11-Syntax/02-Foreign-Function-Interface/src/03-Bindings-Tip-ps.md)
    - [Type Level Programming Syntax](./content/11-Syntax/03-Type-Level-Programming-Syntax/Readme.md)
        - [src]()
            ...
            - [Symbol Syntax.purs](./content/11-Syntax/03-Type-Level-Programming-Syntax/src/11-Symbol-Syntax-ps.md)
            - [Integer Syntax.purs](./content/11-Syntax/03-Type-Level-Programming-Syntax/src/12-Integer-Syntax-ps.md)
            - [Row Syntax.purs](./content/11-Syntax/03-Type-Level-Programming-Syntax/src/21-Row-Syntax-ps.md)
            - [RowList](./content/11-Syntax/03-Type-Level-Programming-Syntax/src/22-RowList.md)
    ...
    - [Modifying Do Ado Syntax Sugar](./content/11-Syntax/06-Modifying-Do-Ado-Syntax-Sugar/Readme.md)
        - [src]()
            ...
            - [Useful Dos](./content/11-Syntax/06-Modifying-Do-Ado-Syntax-Sugar/src/21-Useful-Dos.md)
- [Hello World](./content/21-Hello-World/Readme.md)
    - [Prelude ish](./content/21-Hello-World/01-Prelude-ish/Readme.md)
        - [Basic FP Data Types](./content/21-Hello-World/01-Prelude-ish/01-Basic-FP-Data-Types/Readme.md)
            - [Void](./content/21-Hello-World/01-Prelude-ish/01-Basic-FP-Data-Types/01-Void.md)
            - [Unit](./content/21-Hello-World/01-Prelude-ish/01-Basic-FP-Data-Types/02-Unit.md)
            - [Sum and Product Types](./content/21-Hello-World/01-Prelude-ish/01-Basic-FP-Data-Types/11-Sum-and-Product-Types.md)
            - [Either](./content/21-Hello-World/01-Prelude-ish/01-Basic-FP-Data-Types/12-Either.md)
            - [Maybe](./content/21-Hello-World/01-Prelude-ish/01-Basic-FP-Data-Types/13-Maybe.md)
            - [Tuple](./content/21-Hello-World/01-Prelude-ish/01-Basic-FP-Data-Types/14-Tuple.md)
            - [These](./content/21-Hello-World/01-Prelude-ish/01-Basic-FP-Data-Types/15-These.md)
            - [List](./content/21-Hello-World/01-Prelude-ish/01-Basic-FP-Data-Types/21-List.md)
        - [Miscellaneous Functions](./content/21-Hello-World/01-Prelude-ish/02-Miscellaneous-Functions.md)
    ...
    - [Debugging](./content/21-Hello-World/03-Debugging/Readme.md)
        - [src]()
            ...
            - [Debug](./content/21-Hello-World/03-Debugging/src/03-Debug/Readme.md)
                - [Debug.purs](./content/21-Hello-World/03-Debugging/src/03-Debug/01-Debug-ps.md)
                - [DebugWarning](./content/21-Hello-World/03-Debugging/src/03-Debug/02-DebugWarning.md)
                - [Local State.purs](./content/21-Hello-World/03-Debugging/src/03-Debug/03-Local-State-ps.md)
    ...
    - [Application Structure](./content/21-Hello-World/05-Application-Structure/Readme.md)
        - [src]()
            ...
            - [MTL](./content/21-Hello-World/05-Application-Structure/src/02-MTL/Readme.md)
                ...
                - [State Like Transformers](./content/21-Hello-World/05-Application-Structure/src/02-MTL/17-State-Like-Transformers.md)
    ...
    - [Type Level Programming](./content/21-Hello-World/06-Type-Level-Programming/Readme.md)
        - [src]()
            ...
            - [Symbol Example]()
                - [Proxy.purs](./content/21-Hello-World/06-Type-Level-Programming/src/02-Symbol-Example/01-Proxy-ps.md)
                - [VTAs.purs](./content/21-Hello-World/06-Type-Level-Programming/src/02-Symbol-Example/02-VTAs-ps.md)
            - [Integer Example]()
                - [Proxy.purs](./content/21-Hello-World/06-Type-Level-Programming/src/03-Integer-Example/01-Proxy-ps.md)
                - [VTAs.purs](./content/21-Hello-World/06-Type-Level-Programming/src/03-Integer-Example/02-VTAs-ps.md)
            - [Row Example]()
                - [Proxy.purs](./content/21-Hello-World/06-Type-Level-Programming/src/21-Row-Example/01-Proxy-ps.md)
                - [VTAs.purs](./content/21-Hello-World/06-Type-Level-Programming/src/21-Row-Example/02-VTAs-ps.md)
            - [RowList]()
                - [Simple]()
                    - [Proxy.purs](./content/21-Hello-World/06-Type-Level-Programming/src/22-RowList/01-Simple/01-Proxy-ps.md)
                    - [VTAs.purs](./content/21-Hello-World/06-Type-Level-Programming/src/22-RowList/01-Simple/02-VTAs-ps.md)
                - [Advanced.purs](./content/21-Hello-World/06-Type-Level-Programming/src/22-RowList/02-Advanced-ps.md)
            - [Example Comparisons](./content/21-Hello-World/06-Type-Level-Programming/src/23-Example-Comparisons.md)
            - [Type Level Primitives](./content/21-Hello-World/06-Type-Level-Programming/src/31-Type-Level-Primitives.md)
...
- [Design Patterns](./content/31-Design-Patterns/Readme.md)
    ...
    - [Stack Safety](./content/31-Design-Patterns/23-Stack-Safety/Readme.md)
    ...
    - [Free Data Structures](./content/31-Design-Patterns/27-Free-Data-Structures.md)
    ...
    - [Incorporating Free Structures](./content/31-Design-Patterns/36-Incorporating-Free-Structures.md)
    - [Or Patterns](./content/31-Design-Patterns/37-Or-Patterns.md)
    - [Free Boolean Cube](./content/31-Design-Patterns/38-Free-Boolean-Cube.md)
    ...
    - [Hyperfunctions](./content/31-Design-Patterns/61-Hyperfunctions.md)
